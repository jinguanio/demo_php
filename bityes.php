...
// 火币现货交易API
define('ACCESS_KEY', 'xxxxxxxx-xxxxxxxx-xxxxxxxx-xxxxxxxx'); // 访问密匙 请替换成自己的
define('SECRET_KEY', 'xxxxxxxx-xxxxxxxx-xxxxxxxx-xxxxxxxx'); // 访问私匙 请替换成自己的

// 使用 apiv2
define('API_URL', 'https://api.bityes.com/apiv2');
